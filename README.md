...
This is my submission for the AI Travel Analyst challenge. The idea was pretty simple: take the given flight-price dataset, clean it up, see what actually affects the prices, and turn the results into something useful for a traveler.

I focused on the Exploration part of the challenge.
...
This project was built for the **MIC AIML Department Recruitment Challenge**, under the **Data Science & Visualization — AI Travel Analyst** track.
The focus of this submission is the Exploration part of the challenge: cleaning the data, understanding it, visualizing the important patterns, and turning those patterns into clear conclusions.

The main thing I wanted to demonstrate was not just that I could make charts, but that I could explain **why I made the decisions I made and what the data actually says**.
